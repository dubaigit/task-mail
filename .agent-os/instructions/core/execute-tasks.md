...
Execute tasks for Apple MCP features following three distinct phases:
...
**APPLE MCP CONTEXT**: 
- Backend: Node.js/Express with domain-driven design
- Frontend: React 18 with TypeScript and Zustand
- Database: PostgreSQL (Supabase) + Redis caching
- AI: GPT-5 integration for email intelligence
