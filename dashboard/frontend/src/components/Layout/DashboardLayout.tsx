...
const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className="grid h-screen bg-gray-50" style={{ gridTemplateColumns: '280px 1fr' }}>
      ...
      <div
        className={`
          fixed top-0 left-0 h-full bg-white border-r border-gray-200 z-40 transition-transform duration-300 ease-in-out flex flex-col w-72
          ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}
          md:translate-x-0 md:static md:z-auto
        `}
      >
        {/* Header with logo */}
        <div className="flex items-center p-4 border-b border-gray-200 bg-gray-50/50">
